...
| `npm run pine:sweep` | `node ./scripts/pine-sweep.mjs` | `.pine` source + grid/variant args | sweep leaderboard + best config | writes `pine/sweeps/<runId>/...` | see [pine tooling](./pine-tooling.md#sweeps-and-grid-search) |
