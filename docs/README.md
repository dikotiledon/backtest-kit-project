...
5. [Artifacts and state](./artifacts-and-state.md) — generated files, manifests, queues, and locks.
6. [Operations](./operations.md) — scheduled tasks, wrappers, recovery, and runbooks.
7. [Development](./development.md) — setup, tests, and extension rules.
8. [Reference: modules](./reference/modules.md) and [Reference: schemas](./reference/schemas.md) — implementation inventory and config shape.
...
- any note that describes a behavior without a matching test or current code path

## Deep docs coming next

These paths are reserved for the remaining doc set and are linked here early so navigation stays stable:
- [cli-reference.md](./cli-reference.md)
- [pine-tooling.md](./pine-tooling.md)
- [pine-autoresearch.md](./pine-autoresearch.md)
- [artifacts-and-state.md](./artifacts-and-state.md)
