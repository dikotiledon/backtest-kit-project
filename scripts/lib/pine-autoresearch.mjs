...
export function buildBlockedChallengerEntry(manifest) {
  ...
  return {
    ...
    roiPct: manifest.challenger.roiPct ?? manifest.challenger.metrics?.roiPct ?? null,
    profitFactor: manifest.challenger.profitFactor ?? manifest.challenger.metrics?.profitFactor ?? null,
    maxDrawdownPct: manifest.challenger.maxDrawdownPct ?? manifest.challenger.metrics?.maxDrawdownPct ?? null,
    tradeCount: manifest.challenger.tradeCount ?? manifest.challenger.metrics?.tradeCount ?? null,
    failedGates,
